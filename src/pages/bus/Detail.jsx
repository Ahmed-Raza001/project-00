            ...
            <div className="col-span-1 space-y-8">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-x-2">
                      ...
                      <p className="text-neutral-900 dark:text-neutral-200 text-sm font-normal">
                           Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quis enim quas, quasi corporis, iure nisi asperiores ratione neque hic illum veniam, voluptatem vitae laboriosam nemo!
                           Lorem, ipsum dolor sit amet consectetur adipisicing elit. Officiis id harum perferendis, atque, soluta illo earum magni facilis ducimus aliquam repudiandae. Vitae corporis harum excepturi doloribus?
                        </p>
                </div>
            </div>
