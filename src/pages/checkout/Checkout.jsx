            ...
            <div className="col-span-3 space-y-7 pr-20">
                ...
                <div className="">
                    <label htmlFor="fullname" className="block mb-2 font-semibold">
                        ...
                        <input type="text" id="fullname" placeholder='e.g. G-Tech Official' name="fullname" className="w-full  appearance-none text-neutral-800 dark:text-neutral-100 placeholder:text-neutral-400 dark:placeholder:text-neutral-600 inline-block bg-neutral-200/60 dark:bg-neutral-900/60 px-3 h-12 border border-neutral-200 dark:border-neutral-900 rounded-md focus:outlie-none focus:bg-neutral-100 dark:focus:bg-neutral-900" />
                </div>
                  <div className="">
                    <label htmlFor="email" className="block mb-2 font-semibold">
                        Email Address
                    </label>
                        <input type="text" id="email" placeholder='e.g. gtech.Official08@gmail.com' name="email" className="w-full  appearance-none text-neutral-800 dark:text-neutral-100 placeholder:text-neutral-400 dark:placeholder:text-neutral-600 inline-block bg-neutral-200/60 dark:bg-neutral-900/60 px-3 h-12 border border-neutral-200 dark:border-neutral-900 rounded-md focus:outlie-none focus:bg-neutral-100 dark:focus:bg-neutral-900" />
                  ...
                  <div className="">
                    <label htmlFor="phone" className="block mb-2 font-semibold">
                        ...
                        <input type="text" id="phone" placeholder='e.g. +91 (123) 456-7890' name="phone" className="w-full  appearance-none text-neutral-800 dark:text-neutral-100 placeholder:text-neutral-400 dark:placeholder:text-neutral-600 inline-block bg-neutral-200/60 dark:bg-neutral-900/60 px-3 h-12 border border-neutral-200 dark:border-neutral-900 rounded-md focus:outlie-none focus:bg-neutral-100 dark:focus:bg-neutral-900" />
                </div>
                  <div className="">
                    <label htmlFor="altphone" className="block mb-2 font-semibold">
                        Alternative Phone Nbr.
                    </label>
                        <input type="text" id="aaltphone" placeholder='e.g. +91 (123) 456-7890' name="altphone" className="w-full  appearance-none text-neutral-800 dark:text-neutral-100 placeholder:text-neutral-400 dark:placeholder:text-neutral-600 inline-block bg-neutral-200/60 dark:bg-neutral-900/60 px-3 h-12 border border-neutral-200 dark:border-neutral-900 rounded-md focus:outlie-none focus:bg-neutral-100 dark:focus:bg-neutral-900" />
                </div>
                </form>
            </div>
